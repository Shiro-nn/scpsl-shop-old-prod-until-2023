...
module.exports = function(user, balance, type, title, sum, expires, type){
const html = `<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" >
<title>Уведомление о покупке ${title}</title>
<style type="text/css">
</style>
</head>
<body>
<table cellpadding="0" cellspacing="0" border="0" width="100%" style="background: #27262f; min-width: 320px; font-size: 1px; line-height: normal;">
<tr>
...
<span style="font-family: Arial; color: #000000; font-size: 20px; line-height: 27px;">Приобретено: <b>${type}</b></span>
<div style="height: 8px; line-height: 8px; font-size: 1px;">&nbsp;</div>
<span style="font-family: Arial; color: #000000; font-size: 20px; line-height: 27px;">Аккаунт: <b>${user}</b></span>
<div style="height: 8px; line-height: 8px; font-size: 1px;">&nbsp;</div>
<span style="font-family: Arial; color: #000000; font-size: 20px; line-height: 27px;">Истекает: <b>${expires}</b></span>
<div style="height: 8px; line-height: 8px; font-size: 1px;">&nbsp;</div>
<span style="font-family: Arial; color: #000000; font-size: 20px; line-height: 27px;">Стоимость: <b>${sum}₽</b></span>
<div style="height: 8px; line-height: 8px; font-size: 1px;">&nbsp;</div>
<span style="font-family: Arial; color: #000000; font-size: 20px; line-height: 27px;">Тип: <b>${type}₽</b></span>
<div style="height: 8px; line-height: 8px; font-size: 1px;">&nbsp;</div>
