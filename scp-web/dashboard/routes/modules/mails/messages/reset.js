...
<div style="height: 15px; line-height: 15px; font-size: 0px;">&nbsp;</div>
<div align="left">
<b style="font-family: Arial; color: #000000; font-size: 25px; line-height: 35px;">Запрос на сброс пароля</b>
<div style="height: 30px; line-height: 30px; font-size: 0px;">&nbsp;</div>
<span style="font-family: Arial; color: #000000; font-size: 20px; line-height: 27px;">Если это Вы запросили сброс пароля, то перейдите по <a href="${link}" target="_blank" style="color:red;">ссылке</a>, в противном случае, не предпринимайте никаких действий</span>
