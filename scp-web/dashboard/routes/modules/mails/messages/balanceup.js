...
module.exports = function(user, balance, sum, method){
...
<div style="height: 15px; line-height: 15px; font-size: 0px;">&nbsp;</div>
<div align="left">
<b style="font-family: Arial; color: #000000; font-size: 25px; line-height: 35px;">Уведомление о пополнении баланса</b>
...
<div style="height: 8px; line-height: 8px; font-size: 0px;">&nbsp;</div>
<span style="font-family: Arial; color: #000000; font-size: 20px; line-height: 27px;">Сумма: <b>${sum}₽</b></span>
<div style="height: 8px; line-height: 8px; font-size: 0px;">&nbsp;</div>
<span style="font-family: Arial; color: #000000; font-size: 20px; line-height: 27px;">Текущий баланс: <b>${balance}₽</b></span>
<div style="height: 8px; line-height: 8px; font-size: 0px;">&nbsp;</div>
<span style="font-family: Arial; color: #000000; font-size: 20px; line-height: 27px;">Метод: <b>${method}</b></span>
</div>
<div style="height: 15px; line-height: 15px; font-size: 0px;">&nbsp;</div>
</td>
</tr>
