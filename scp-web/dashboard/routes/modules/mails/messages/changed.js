...
module.exports = function(user, ipinfo, browser){
...
<title>Уведомление об изменении пароля</title>
<style type="text/css">
</style>
</head>
<body>
...
<a href="https://scpsl.shop" target="_blank" style="display: block; max-width: 600px;">
<img src="https://cdn.scpsl.shop/another/0821dee79c59/_logo.png" alt="" width="600" border="0" style="display: block; width: 600px; max-width: 100%;">
</a>
<div style="height: 15px; line-height: 15px; font-size: 0px;">&nbsp;</div>
...
<div style="height: 15px; line-height: 15px; font-size: 0px;">&nbsp;</div>
<div align="left">
<b style="font-family: Arial; color: #000000; font-size: 25px; line-height: 35px;">Уведомление об изменении пароля</b>
<div style="height: 30px; line-height: 30px; font-size: 0px;">&nbsp;</div>
<span style="font-family: Arial; color: #000000; font-size: 20px; line-height: 27px;">Ваш пароль успешно изменен<br>Если это не Вы, заново сбросьте пароль<br>Вы можете открыть тикет в дискорде, если хотите откатить данные аккаунта</span>
...
<div style="height: 15px; line-height: 15px; font-size: 0px;">&nbsp;</div>
<img src="https://api.mapbox.com/styles/v1/mapbox/satellite-streets-v11/static/${loc},7,0/620x400?logo=false&access_token=" alt="" width="620" border="0" style="display: block; width: 620px; max-width: 100%;">
<div style="height: 15px; line-height: 15px; font-size: 0px;">&nbsp;</div>
</td>
</tr>
</table>
