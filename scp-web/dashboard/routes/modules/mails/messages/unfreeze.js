                                        ...
                                        <table cellpadding="0" cellspacing="0" border="0" width="620" class="table700" style="max-width: 620px; min-width: 280px;">
                                            <tr>
                                                <td align="center" valign="top">
                                                    <div style="height: 15px; line-height: 15px; font-size: 0px;">&nbsp;</div>
                                                    <div align="left">
                                                        <b style="font-family: Arial; color: #000000; font-size: 25px; line-height: 35px;">Уведомление об автоматической разморозке доната</b>
                                                        ...
                                                        <span style="font-family: Arial; color: #000000; font-size: 20px; line-height: 27px;">Аккаунт: <b>${nick}</b></span>
                                                        <div style="height: 8px; line-height: 8px; font-size: 0px;">&nbsp;</div>
                                                        <span style="font-family: Arial; color: #000000; font-size: 20px; line-height: 27px;">Донат: <b>${donate}</b></span>
                                                        <div style="height: 8px; line-height: 8px; font-size: 0px;">&nbsp;</div>
                                                        <span style="font-family: Arial; color: #000000; font-size: 20px; line-height: 27px;">Причина: <b>Истекло доступное время заморозки</b></span>
                                                    </div>
                                                    <div style="height: 15px; line-height: 15px; font-size: 0px;">&nbsp;</div>
                                                </td>
                                            </tr>
