...
const geoIP = require('../../dashboard/routes/modules/auth/geoIP');
const userAgent = require('../../dashboard/routes/modules/auth/userAgent');
const crypt = require('../../dashboard/routes/modules/auth/cryptoData');
            ...
            req.bs = {
                ...
                save: async function(expires = config.expires) {
                    ...
                    async function MongoUpdate() {
                        ...
                        else{_data.data = JSON.stringify(req.bs.data); _data.last = Date.now(); await _data.save();}
                    }
                },
